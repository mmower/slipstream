...
const game = new RezGame(
  ...
  {"$flash_messages": [],
"$global": true,
"$init_order": ["asset_source_explorer_html", "_PLURALIZE_JS", "$load_game", "$load_game_form", "$actor_behaviours", "$select", "$select_r", "$select_p", "$sequence", "$loop", "$loop_until", "$maybe", "$either", "$random_choice", "$random_each", "$always", "$never", "$invert", "$fail", "$succeed", "_ALPINE_JS", "_BULMA_CSS", "js_popper", "js_tippy", "sc_char_sheet", "c_char_sheet", "player", "sc_main", "c_intro"],
...
"$dist_path": "assets/source_explorer/source_explorer.html",
...
;
  ...
  {"$auto_id_idx": 0,
"$detected_mime_type": "text/javascript",
"$dist_path": "assets/js/popper.min.js",
"$global": false,
"$inline": false,
"$js_defer": false,
"$js_runtime": false,
"$mixins": [],
"$pre_runtime": true,
"$source_path": "assets/js/popper.min.js",
"$template": false,
...
;
  ...
  {"$auto_id_idx": 0,
"$detected_mime_type": "text/javascript",
"$dist_path": "assets/js/tippy.min.js",
"$global": false,
"$inline": false,
"$js_defer": false,
"$js_runtime": false,
"$mixins": [],
"$pre_runtime": true,
"$source_path": "assets/js/tippy.min.js",
"$template": false,
...
;
  ...
  {"$auto_id_idx": 0,
"$global": false,
"$layout_template": function(bindings) {return [function(bindings) {return `<div id="scene_sc_char_sheet" data-scene="sc_char_sheet" class="rez-scene">`;},function(bindings) {return (function(bindings) {return bindings.content;})(bindings);},function(bindings) {return `
</div>`;}].reduce(function(text, f) {return text + f(bindings)}, "");},
"$mixins": [],
"$running": false,
"$template": false,
"bindings": [{prefix: "player", deref: false, source: {$ref: "player"}}],
"current_card_id": "",
"initial_card_id": {$ref: "c_char_sheet"},
"last_card_id": "",
"layout_mode": "single",
"layout_reverse": false,
"layout_separator": ""}
...
;
  ...
  "c_char_sheet",
  {"$auto_id_idx": 0,
"$content_template": function(bindings) {return [function(bindings) {return `<div id="card_c_char_sheet" data-card="c_char_sheet" class="rez-front-face"><div>Character Sheet</div>
<div class="columns">
<div class="column is-one-fifth">
<div>Name</div>
<div>`;},function(bindings) {return (function(bindings) {return bindings.player.name;})(bindings);},function(bindings) {return `</div>
<div>Credits</div>
<div>`;},function(bindings) {return (function(bindings) {return bindings.player.credits;})(bindings);},function(bindings) {return `</div>
</div>
<div class="column">
`;},function(bindings) {return (function(bindings) {return bindings.content;})(bindings);},function(bindings) {return `
</div>
</div>
</div>`;}].reduce(function(text, f) {return text + f(bindings)}, "");},
"$flipped": false,
...
<div class="hero-body">
<p class="title">`;},function(bindings) {return (function(bindings) {return bindings.card.game.title;})(bindings);},function(bindings) {return ` `;},function(bindings) {return $build;},function(bindings) {return `</p>
...
<p>Explore the <a target="_blank" href=`;},function(bindings) {return (function(bindings) {return bindings.source_explorer.$dist_path;})(bindings);},function(bindings) {return `>source</a>.</p>
...
"$suppress_wrapper": false,
"$template": false,
"bindings": [{prefix: "source_explorer", deref: false, source: {$ref: "asset_source_explorer_html"}}]}
)
;
  game.addGameObject(el);
...
function rez_keybinding_listener(event) {
  ...
  pred = (event) => !event.shiftKey && !event.metaKey && !event.ctrlKey && !event.altKey && event.key === "Escape";
  if(pred(event)) {
    console.log("Dispatching: end_interlude");
    ep.dispatchResponse(ep.raiseKeyBindingEvent("end_interlude"));
  }

  pred = (event) => event.shiftKey && !event.metaKey && !event.ctrlKey && !event.altKey && event.key === "C";
  if(pred(event)) {
    console.log("Dispatching: show_character_sheet");
    ep.dispatchResponse(ep.raiseKeyBindingEvent("show_character_sheet"));
  }
